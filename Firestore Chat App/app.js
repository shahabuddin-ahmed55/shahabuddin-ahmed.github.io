...
// const setData = (user) => {
//     firestore.collection('user').doc(user.uid).get().then((querySnapshot) => {
...
//                 creatElementsForMessages(change.doc.data());
//             }
//         })
//     })
// }
...
//     messageTextDiv.classList.add("messages-text");
